  ...
  return (
    ...
    >
      <div className=" bg-white text-black  h-[580px] ">
        <div className=" h-[580px] relative justify-end pb-[53px]  flex flex-col overflow-hidden bg-[#f5f5f7] ">
          <a
            style={{
              position: "absolute",
              bottom: 0,
          ...
          >
            <h3
              style={{
                ...
                maxWidth: 430,
                backgroundImage:
                  "url(https://www.apple.com/v/home/bp/images/logos/apple-vision-pro/promo_logo_apple_vision_pro__90zi46p7dc2y_large_2x.png)",
                backgroundRepeat: "no-repeat",
                backgroundSize: "198px 34px",
                width: "198px",
                height: 34,
                textAlign: "center",
              }}
